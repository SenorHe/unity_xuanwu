...
namespace UnityGameFramework.Editor.ResourceTools
{
    public sealed partial class ResourceBuilderController
    {
        ...
        {
            m_ConfigurationPath = Type.GetConfigurationPath<ResourceBuilderConfigPathAttribute>() ?? Utility.Path.GetRegularPath(Path.Combine(Application.dataPath, "Vendor/UnityGameFramework-master/Configs/ResourceBuilder.xml"));
        ...
        private BuildAssetBundleOptions GetBuildAssetBundleOptions()
        {
            ...
            // AssetBundle builds are always deterministic in modern Unity versions.
