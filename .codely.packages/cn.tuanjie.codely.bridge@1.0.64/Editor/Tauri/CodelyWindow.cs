...
// #endif
        ...
        private void OnEnable()
        {
            ...
            if (!_eventTrackedOnEnable)
            {
                ...
                CodelyEventTracker.Track(CodelyEventTracker.CodelyPanelOpened);
            }
        ...
        private void OnDisable()
        {
            ...
            // Track panel closed before releasing IPC client so the message
            // can be buffered and flushed while the connection is still alive.
            CodelyEventTracker.Track(CodelyEventTracker.CodelyPanelClosed);
            ReleaseIpcClient();
